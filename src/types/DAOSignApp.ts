...
export type ProofOfAgreementStructOutput = [agreementCID: string, signatureCIDs: string[], app: string, timestamp: bigint, metadata: string] & {
  agreementCID: string;
  signatureCIDs: string[];
  app: string;
  timestamp: bigint;
...
export type SignedProofOfAgreementStructOutput = [message: ProofOfAgreementStructOutput, signature: string, proofCID: string] & {
...
export type ProofOfSignatureStructOutput = [name: string, signer: string, agreementCID: string, app: string, timestamp: bigint, metadata: string] & {
  name: string;
  signer: string;
  agreementCID: string;
  app: string;
...
export type EIP712ProofOfAgreementTypesStruct = {
  EIP712Domain: [EIP712PropertyTypeStruct, EIP712PropertyTypeStruct, EIP712PropertyTypeStruct, EIP712PropertyTypeStruct];
...
export type EIP712ProofOfAgreementTypesStructOutput = [
  EIP712Domain: [EIP712PropertyTypeStructOutput, EIP712PropertyTypeStructOutput, EIP712PropertyTypeStructOutput, EIP712PropertyTypeStructOutput],
  ProofOfAgreement: [
...
export type SignedProofOfAgreementMsgStructOutput = [message: EIP712ProofOfAgreementStructOutput, signature: string] & {
